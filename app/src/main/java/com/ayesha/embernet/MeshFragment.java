...
public class MeshFragment extends Fragment {
    ...
    // statusDot is a View not a TextView — it is a colored circle
    ...
    public void onViewCreated(@NonNull View view,
        ...
        statusDot  = view.findViewById(R.id.mesh_status_dot);
        meshStatus = view.findViewById(R.id.mesh_status_text);
        relayCount = view.findViewById(R.id.mesh_relay_count_val);
    ...
    private void updateMeshStatus() {
        ...
        try {
            ...
            if (bleCount != null) {
                bleCount.setText(String.valueOf(blePeers));
            }
            if (wifiCount != null) {
                wifiCount.setText(
    ...
    private void setupDiagnostics(View view) {
        ...
        btn.setOnClickListener(v -> {
            try {
                ...
                output.setText("Diagnostics error: "
                        + e.getMessage());
            }
        });
    }
    ...
    private void runDiagnostics(TextView output) {
        ...
        sb.append("Enabled: ").append(
                        adapter != null && adapter.isEnabled()
                                ? "YES \u2713" : "NO \u274c")
                .append("\n");
        sb.append("Multi-advert: ").append(
                        adapter != null
                                && adapter.isMultipleAdvertisementSupported()
                                ? "YES \u2713" : "NO \u274c")
                .append("\n");
        sb.append("LE supported: ").append(
        ...
        try {
            ...
            sb.append("Active: ").append(
                            mesh.isActive()
                                    ? "YES \u2713" : "NO \u274c")
                    .append("\n");
            sb.append("BLE peers: ").append(
                            mesh.getBleScanner() != null
                                    ? mesh.getBleScanner().getPeerCount()
                                    : 0)
                    .append("\n");
            sb.append("WiFi peers: ").append(
                            mesh.getWifiDirect() != null
                                    ? mesh.getWifiDirect().getPeerCount()
                                    : 0)
                    .append("\n\n");
        } catch (Exception e) {
        ...
        sb.append("Wi-Fi enabled: ").append(
